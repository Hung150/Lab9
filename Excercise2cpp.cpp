#include<stdio.h>//c-n,e-b,s-io,w-3
#include<conio.h>

int main(){
	char S;
	int N;
	printf(" enter symbol direction (e - east, w - west, s - south, n - north)"); scanf("%c", &S);
	printf(" enter the digital command for the robot(0 - continue moving, 1 - turn left, -1 - turn right)"); scanf("%i",&N);
	printf(" direction - ");
	switch(N){
		case 1: switch(S){
